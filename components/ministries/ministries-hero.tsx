    ...
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: `url('/diverse-ministry-volunteers-serving-together.jpg')`,
          }}
        />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="space-y-6">
          ...
          >
            Discover Your
            <br />
            <span className="text-warm-orange">Ministry</span>
          </h1>
          <p
          ...
          >
            Every gift, every passion, every person matters. Join us in making a difference through meaningful ministry.
          </p>
        </div>
      </div>
    </section>
